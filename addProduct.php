...
<div class="container border border-6 bg-lgt-green border-white m-5 p-5 h-50 w-75">
  <form class=" mb-5 mt-5 bg-lgt-green w-100 text-white" action="addProduct.php" method="post">
    ...
    <div class="form-row flex-column d-flex flex-column">
      ...
      <div class="col-12 mb-3">
        <textarea type="text" class="form-control bg-lgt-green border-white rounded-0"  name="description" placeholder="Description" rows="3" value="<?php if (isset($_SESSION["form"]['name'])){echo $_SESSION["form"]['name'];} ?>"></textarea>
